/* Pirumatic - TinyMCE Buttons for Plain Flavor */

(function() {
	
	'use strict';
	
	tinymce.create('tinymce.plugins.PirumaticButtons', {
	...
	tinymce.PluginManager.add('pirumatic_buttons', tinymce.plugins.PirumaticButtons);
