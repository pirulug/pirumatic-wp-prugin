<?php // Pirumatic - Validate Settings

if (!defined('ABSPATH')) exit;

function pirumatic_validate_general($input) {
	
	$library = pirumatic_library();
...
function pirumatic_validate_prism($input) {
	
	
	$prism_theme = pirumatic_prism_theme();
...
function pirumatic_validate_highlight($input) {
	
	$highlight_theme = pirumatic_highlight_theme();
...
function pirumatic_validate_plain($input) {
...
function pirumatic_validate_advanced($input) {
